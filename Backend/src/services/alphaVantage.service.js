...
function pickMetrics(overview = {}) {
  return {
    ...
    debtToEquity: toNumber(overview.DebtToEquity),
    revenueTTM: toNumber(overview.RevenueTTM),
    quarterlyRevenueGrowthYOY: toNumber(overview.QuarterlyRevenueGrowthYOY),
    quarterlyEarningsGrowthYOY: toNumber(overview.QuarterlyEarningsGrowthYOY),
